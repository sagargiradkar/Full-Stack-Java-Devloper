...
//        reader.loadBeanDefinitions("src/main/java/in/ineuron/cfg/applicationContext.xml");
        ApplicationContext factory = new FileSystemXmlApplicationContext("src/main/java/in/ineuron/cfg/applicationContext.xml");
//        ClassPathXmlApplicationContext factory = new ClassPathXmlApplicationContext("src/main/java/in/ineuron/cfg/applicationContext.xml");
